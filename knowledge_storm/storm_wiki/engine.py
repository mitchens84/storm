...
class STORMWikiLMConfigs(LMConfigs):
    ...
    def init_openai_model(
        ...
        if openai_type and openai_type == 'openai':
            self.conv_simulator_lm = OpenAIModel(model='gpt-4o-mini',
            ...
            self.outline_gen_lm = OpenAIModel(model='gpt-4o-mini',
                                              max_tokens=400, **openai_kwargs)
            self.article_gen_lm = OpenAIModel(model='gpt-4o-mini',
                                              max_tokens=700, **openai_kwargs)
            self.article_polish_lm = OpenAIModel(model='gpt-4o-mini',
